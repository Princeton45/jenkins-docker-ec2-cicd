...
Below is the complete code for the Jenkins pipeline
...
```
![success2](https://github.com/Princeton45/jenkins-docker-ec2-cicd/blob/main/images/success2.png)

You can also see the successful version bump in the `commit version update` stage of the pipeline.

![commit](https://github.com/Princeton45/jenkins-docker-ec2-cicd/blob/main/images/commit.png)
